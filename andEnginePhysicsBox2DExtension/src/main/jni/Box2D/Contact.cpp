...
JNICALL Java_com_badlogic_gdx_physics_box2d_Contact_jniGetWorldManifold
...
JNICALL Java_com_badlogic_gdx_physics_box2d_Contact_jniIsTouching
...
Java_com_badlogic_gdx_physics_box2d_Contact_jniSetEnabled
(JNIEnv
*, jobject,
jlong addr, jboolean
flag)
...
JNICALL Java_com_badlogic_gdx_physics_box2d_Contact_jniIsEnabled
        (JNIEnv *, jobject, jlong addr) {
    b2Contact *contact = (b2Contact *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_Contact_jniGetFixtureA
        (JNIEnv *, jobject, jlong addr) {
    b2Contact *contact = (b2Contact *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_Contact_jniGetFixtureB
        (JNIEnv *, jobject, jlong addr) {
    b2Contact *contact = (b2Contact *) addr;
