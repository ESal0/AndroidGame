...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_DistanceJoint_jniGetLength
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_DistanceJoint_jniGetFrequency
        (JNIEnv *, jobject, jlong addr) {
    b2DistanceJoint *joint = (b2DistanceJoint *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_DistanceJoint_jniGetDampingRatio
        (JNIEnv *, jobject, jlong addr) {
    b2DistanceJoint *joint = (b2DistanceJoint *) addr;
