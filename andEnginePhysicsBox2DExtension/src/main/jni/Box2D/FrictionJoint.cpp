...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_FrictionJoint_jniGetMaxForce
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_FrictionJoint_jniGetMaxTorque
        (JNIEnv *, jobject, jlong addr) {
    b2FrictionJoint *joint = (b2FrictionJoint *) addr;
