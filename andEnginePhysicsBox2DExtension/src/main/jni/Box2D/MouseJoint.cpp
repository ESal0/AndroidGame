...
y;
env->
ReleasePrimitiveArrayCritical( target, tmp,
0);
}
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_MouseJoint_jniGetMaxForce
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_MouseJoint_jniGetFrequency
        (JNIEnv *, jobject, jlong addr) {
    b2MouseJoint *joint = (b2MouseJoint *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_MouseJoint_jniGetDampingRatio
        (JNIEnv *, jobject, jlong addr) {
    b2MouseJoint *joint = (b2MouseJoint *) addr;
