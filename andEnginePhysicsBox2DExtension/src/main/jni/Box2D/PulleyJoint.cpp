...
y;
env->
ReleasePrimitiveArrayCritical( anchor, tmp,
0);
}
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_PulleyJoint_jniGetLength1
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_PulleyJoint_jniGetLength2
        (JNIEnv *, jobject, jlong addr) {
    b2PulleyJoint *joint = (b2PulleyJoint *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_joints_PulleyJoint_jniGetRatio
        (JNIEnv *, jobject, jlong addr) {
    b2PulleyJoint *joint = (b2PulleyJoint *) addr;
