...
public:
    ...
    virtual float32 ReportFixture(b2Fixture *fixture, const b2Vec2 &point, const b2Vec2 &normal,
                                  float32 fraction) {
        return env->CallFloatMethod(obj, reportRayFixtureID, (jlong) fixture, (jfloat) point.x,
                                    (jfloat) point.y,
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_newWorld
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateBody
        (JNIEnv *, jobject, jlong addr, jint type, jfloat positionX, jfloat positionY, jfloat angle,
         jfloat linearVelocityX, jfloat linearVelocityY, jfloat angularVelocity,
         jfloat linearDamping, jfloat angularDamping, jboolean allowSleep, jboolean awake,
         jboolean fixedRotation, jboolean bullet, jboolean active, jfloat inertiaScale) {
    b2BodyDef bodyDef;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateDistanceJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateFrictionJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateGearJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jlong joint1, jlong joint2, jfloat ratio) {
    b2World *world = (b2World *) addr;
    b2GearJointDef def;
    def.bodyA = (b2Body *) bodyA;
    def.bodyB = (b2Body *) bodyB;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateLineJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
         jfloat localAxisAX, jfloat localAxisAY, jboolean enableLimit, jfloat lowerTranslation,
         jfloat upperTranslation,
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateMouseJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat targetX, jfloat targetY, jfloat maxForce, jfloat frequencyHz, jfloat dampingRatio) {
    b2World *world = (b2World *) addr;
    b2MouseJointDef def;
    def.bodyA = (b2Body *) bodyA;
    def.bodyB = (b2Body *) bodyB;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreatePrismaticJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
         jfloat localAxisAX, jfloat localAxisAY, jfloat referenceAngle, jboolean enableLimit,
         jfloat lowerTranslation, jfloat upperTranslation,
         jboolean enableMotor, jfloat maxMotorForce, jfloat motorSpeed) {
    b2World *world = (b2World *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreatePulleyJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat groundAnchorAX, jfloat groundAnchorAY, jfloat groundAnchorBX, jfloat groundAnchorBY,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
         jfloat lengthA, jfloat maxLengthA,
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateRevoluteJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
         jfloat referenceAngle, jboolean enableLimit, jfloat lowerAngle, jfloat upperAngle,
         jboolean enableMotor, jfloat motorSpeed, jfloat maxMotorTorque) {
    b2World *world = (b2World *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateWeldJoint
        (JNIEnv *, jobject, jlong addr, jlong bodyA, jlong bodyB, jboolean collideConnected,
         jfloat localAnchorAX, jfloat localAnchorAY, jfloat localAnchorBX, jfloat localAnchorBY,
 ...
 */
JNIEXPORT void JNICALL
Java_com_badlogic_gdx_physics_box2d_World_jniSetWarmStarting
(JNIEnv
*, jobject,
jlong addr, jboolean
flag)
 ...
 */
JNIEXPORT void JNICALL
Java_com_badlogic_gdx_physics_box2d_World_jniSetContiousPhysics
(JNIEnv
*, jobject,
jlong addr, jboolean
flag)
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniGetProxyCount
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniGetBodyCount
        (JNIEnv *, jobject, jlong addr) {
    b2World *world = (b2World *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniGetJointcount
        (JNIEnv *, jobject, jlong addr) {
    b2World *world = (b2World *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniGetContactCount
        (JNIEnv *, jobject, jlong addr) {
    b2World *world = (b2World *) addr;
...
y;
env->
ReleasePrimitiveArrayCritical( gravity, tmp,
0);
}
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniIsLocked
        (JNIEnv *, jobject, jlong addr) {
    b2World *world = (b2World *) addr;
...
JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniGetAutoClearForces
        (JNIEnv *, jobject, jlong addr) {
    b2World *world = (b2World *) addr;
...
env->
ReleasePrimitiveArrayCritical( contacts, tmp,
0 );
}
